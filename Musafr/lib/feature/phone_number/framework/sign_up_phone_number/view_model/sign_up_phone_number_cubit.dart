...
class SignUpPhoneNumberCubit extends Cubit<SignUpPhoneNumberState> {
  ...
  final SignUpPhoneNumberUseCase signInPhoneNumberUseCase;
      ...
      case DomainFailure(:final error):
        {
          // emit(
          //   state.copyWith(
          //     screenState: UiSuccess(data: false),
          //     switchScreenState: true,
          //   ),
          // );
          emit(
            state.copyWith(screenState: UiError(data: true, message: error)),
          );
          return;
        }
    }
  ...
  void updateSignInEnabled() {
    emit(
      state.copyWith(
        screenState: UiSuccess(data: state.phoneState is UiSuccess),
      ),
    );
  }
